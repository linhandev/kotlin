...
object NativeRuntimeNames {
    ...
    object Annotations {
        ...
        val exportForCppRuntimeNoStubClassId = ClassId(kotlinNativeInternalPackage, Name.identifier("ExportForCppRuntimeNoStub"))
        val gcUnsafeCallClassId = ClassId(kotlinNativeInternalPackage, Name.identifier("GCUnsafeCall"))
        val gcSafeCallClassId = ClassId(kotlinNativeInternalPackage, Name.identifier("GCSafeCall"))
