...
// CHECK-STACKMAP: call ptr addrspace(1) @ReadVolatileHeapRefStub(ptr addrspace(1) noundef %{{[0-9]+}}, ptr addrspace(1) noundef %{{[0-9]+}})
...
// CHECK-STACKMAP: call ptr @Kotlin_arrayGetElementAddress(ptr addrspace(1) noundef %{{[0-9]+}}, i32 noundef 0)
// CHECK-NOSTACKMAP: call ptr @Kotlin_arrayGetElementAddress(ptr noundef %{{[0-9]+}}, i32 noundef 0)
// CHECK-STACKMAP: call void @UpdateVolatileHeapRef(ptr addrspace(1) noundef %{{[0-9]+}}, ptr addrspace(1) noundef null, ptr addrspace(1) noundef %{{[0-9]+}})
...
// CHECK-STACKMAP: call ptr @Kotlin_arrayGetElementAddress(ptr addrspace(1) noundef %{{[0-9]+}}, i32 noundef 0)
// CHECK-NOSTACKMAP: call ptr @Kotlin_arrayGetElementAddress(ptr noundef %{{[0-9]+}}, i32 noundef 0)
// CHECK-STACKMAP: call ptr addrspace(1) @GetAndSetVolatileHeapRef(ptr addrspace(1) noundef %{{[0-9]+}}, ptr addrspace(1) noundef null, ptr addrspace(1) noundef %{{[0-9]+}}, ptr noundef %{{[0-9]+}})
...
// CHECK-STACKMAP: call ptr @Kotlin_arrayGetElementAddress(ptr addrspace(1) noundef %{{[0-9]+}}, i32 noundef 0)
// CHECK-NOSTACKMAP: call ptr @Kotlin_arrayGetElementAddress(ptr noundef %{{[0-9]+}}, i32 noundef 0)
// CHECK-STACKMAP: call ptr addrspace(1) @CompareAndSwapVolatileHeapRef(ptr addrspace(1) noundef %{{[0-9]+}}, ptr addrspace(1) noundef null, ptr addrspace(1) noundef null, ptr addrspace(1) noundef %{{[0-9]+}}, ptr noundef %{{[0-9]+}})
...
// CHECK-STACKMAP: call ptr @Kotlin_arrayGetElementAddress(ptr addrspace(1) noundef %{{[0-9]+}}, i32 noundef 0)
// CHECK-NOSTACKMAP: call ptr @Kotlin_arrayGetElementAddress(ptr noundef %{{[0-9]+}}, i32 noundef 0)
// CHECK-STACKMAP-AAPCS: call i1 @CompareAndSetVolatileHeapRef(ptr addrspace(1) noundef %{{[0-9]+}}, ptr addrspace(1) noundef null, ptr addrspace(1) noundef null, ptr addrspace(1) noundef %{{[0-9]+}})
// CHECK-NOSTACKMAP-AAPCS: call i1 @CompareAndSetVolatileHeapRef(ptr noundef %{{[0-9]+}}, ptr noundef null, ptr noundef null)
// CHECK-STACKMAP-DEFAULTABI: call zeroext i1 @CompareAndSetVolatileHeapRef(ptr addrspace(1) noundef %{{[0-9]+}}, ptr addrspace(1) noundef null, ptr addrspace(1) noundef null, ptr addrspace(1) noundef %{{[0-9]+}})
...
// CHECK-STACKMAP-WINDOWSX64: call zeroext i1 @CompareAndSetVolatileHeapRef(ptr addrspace(1) noundef %{{[0-9]+}}, ptr addrspace(1) noundef null, ptr addrspace(1) noundef null, ptr addrspace(1) noundef %{{[0-9]+}})
