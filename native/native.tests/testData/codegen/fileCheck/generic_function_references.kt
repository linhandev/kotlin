...
// CHECK-STACKMAP-SAME: (ptr addrspace(1) [[this:%[0-9]+]], ptr addrspace(1) [[array:%[0-9]+]], ptr addrspace(1) {{%[0-9]+}})
...
// CHECK-STACKMAP-DEBUG: call i32 @"kfun:stringifyArray$1.invoke#internal"(ptr addrspace(1) {{%[0-9]+}}, ptr {{%[0-9]+}})
...
// CHECK-STACKMAP-SAME: (ptr addrspace(1) [[this:%[0-9]+]], ptr addrspace(1) [[array:%[0-9]+]], i32 [[index:%[0-9]+]], ptr addrspace(1) [[ret:%[0-9]+]])
// CHECK-NOSTACKMAP-SAME: (ptr [[this:%[0-9]+]], ptr [[array:%[0-9]+]], i32 [[index:%[0-9]+]], ptr [[ret:%[0-9]+]])
// CHECK-STACKMAP-OPT: call ptr addrspace(1) @Kotlin_Array_get(ptr [[array]], i32 [[index]], ptr [[ret]])
// CHECK-NOSTACKMAP-OPT: call ptr @Kotlin_Array_get(ptr [[array]], i32 [[index]], ptr [[ret]])
// CHECK-STACKMAP-DEBUG: call ptr addrspace(1) @Kotlin_Array_get(ptr {{%[0-9]+}}, i32 {{%[0-9]+}}, ptr {{%[0-9]+}})
...
// CHECK-STACKMAP-SAME: (ptr addrspace(1) [[this:%[0-9]+]], ptr addrspace(1) [[array:%[0-9]+]], ptr addrspace(1) [[boxedIndex:%[0-9]+]], ptr addrspace(1) [[ret:%[0-9]+]])
// CHECK-NOSTACKMAP-SAME: (ptr [[this:%[0-9]+]], ptr [[array:%[0-9]+]], ptr [[boxedIndex:%[0-9]+]], ptr [[ret:%[0-9]+]])
// CHECK-STACKMAP-OPT: call ptr addrspace(1) @"kfun:stringifyArray$$FUNCTION_REFERENCE_FOR$get$0.invoke#internal"(ptr [[this]], ptr addrspace(1) {{%[0-9]+}}, i32 {{%[0-9]+}}, ptr [[ret]])
...
// CHECK-STACKMAP-DEBUG: call i32 @"kfun:stringifyIntArray$1.invoke#internal"(ptr addrspace(1) {{%[0-9]+}}, ptr {{%[0-9]+}})
...
// CHECK-STACKMAP-SAME: (ptr addrspace(1) [[this:%[0-9]+]], ptr addrspace(1) [[array:%[0-9]+]], ptr addrspace(1) {{%[0-9]+}}, ptr addrspace(1) {{%[0-9]+}})
// CHECK-NOSTACKMAP-SAME: (ptr [[this:%[0-9]+]], ptr [[array:%[0-9]+]], ptr {{%[0-9]+}}, ptr {{%[0-9]+}})
// CHECK-STACKMAP-OPT: call i32 @"kfun:stringifyIntArray$$FUNCTION_REFERENCE_FOR$get$1.invoke#internal"(ptr [[this]], ptr addrspace(1) {{%[0-9]+}}, i32 {{%[0-9]+}})
...
// CHECK-STACKMAP-DEBUG: call void @"kfun:#foo(0:0;0:1){0\C2\A7<kotlin.Any?>;1\C2\A7<kotlin.Any?>}"(ptr addrspace(1) {{%[0-9]+}}, ptr {{%[0-9]+}})
...
// CHECK-STACKMAP-SAME: (ptr addrspace(1) [[this:%[0-9]+]], ptr addrspace(1) [[p1:%[0-9]+]], ptr addrspace(1) [[p2:%[0-9]+]], ptr addrspace(1) {{%[0-9]+}})
...
// CHECK-STACKMAP-DEBUG: call void @"kfun:bar$ref$$FUNCTION_REFERENCE_FOR$foo$2.invoke#internal"(ptr addrspace(1) {{%[0-9]+}}, ptr addrspace(1) {{%[0-9]+}}, ptr {{%[0-9]+}})
...
// CHECK-STACKMAP: call void @"kfun:#foo(0:0;0:1){0\C2\A7<kotlin.Any?>;1\C2\A7<kotlin.Any?>}"(ptr addrspace(1) {{%[0-9]+}}, ptr {{%[0-9]+}})
...
// CHECK-STACKMAP-SAME: (ptr addrspace(1) [[this:%[0-9]+]], ptr addrspace(1) {{%[0-9]+}}, ptr addrspace(1) {{%[0-9]+}}, ptr addrspace(1) {{%[0-9]+}})
