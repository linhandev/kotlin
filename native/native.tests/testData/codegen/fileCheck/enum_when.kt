...
fun box(): String {
    for (i in COLOR.values()) {
        ...
        // CHECK-STACKMAP-OPT: getelementptr inbounds %"kclassbody:kotlin.Enum#internal", ptr addrspace(1) %{{[0-9a-z]*}}, i32 0, i32 2
        // CHECK-NOSTACKMAP-OPT: getelementptr inbounds %"kclassbody:kotlin.Enum#internal", ptr %{{[0-9a-z]*}}, i32 0, i32 2
        print(when (i) {
