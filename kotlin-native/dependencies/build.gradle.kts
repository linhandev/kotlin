...
nativeDependenciesDownloader {
    repositoryURL.set("https://cache-redirector.jetbrains.com/download.jetbrains.com/kotlin/native,https://maven.eazytec-cloud.com/nexus/repository/file-storage")
