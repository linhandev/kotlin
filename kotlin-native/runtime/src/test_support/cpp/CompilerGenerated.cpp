...
extern const int32_t Kotlin_memoryManagerMode = static_cast<int32_t>(kotlin::compiler::MemoryManagerMode::kNative);
extern const int32_t Kotlin_isHwasanEnabled = 0;
#if KONAN_WINDOWS
