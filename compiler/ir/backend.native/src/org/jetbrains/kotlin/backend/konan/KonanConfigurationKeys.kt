...
class KonanConfigKeys {
    companion object {
        ...
        /** Value of kotlin.native.debuginfo.minify from gradle.properties (boolean), passed via -Xnative-debuginfo-minify. Only has effect on Ohos targets. */
        val NATIVE_DEBUGINFO_MINIFY: CompilerConfigurationKey<Boolean?> = CompilerConfigurationKey.create("native debuginfo minify option")
    }
}
