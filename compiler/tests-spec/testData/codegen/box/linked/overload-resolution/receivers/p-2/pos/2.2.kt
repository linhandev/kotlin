 ...
 * NUMBER: 2
 * DESCRIPTION: member function on implicit this beats companion object callable with same name
 */
...
fun box(): String {
    val test = Case1102()
    test.case()
    return if (test.isImplicitReceiverCalled && !Case1102Base.isCompanionObjectReceiverCalled) "OK" else "NOK"
}
