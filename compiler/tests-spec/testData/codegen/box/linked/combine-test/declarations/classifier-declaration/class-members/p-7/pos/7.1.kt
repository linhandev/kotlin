 ...
 * NUMBER: 1
 * DESCRIPTION: class member operator fun minusAssign desugars to member call in augmented assignment
 */
...
fun test(): Int = MutableVector(5).also { it -= MutableVector(2) }.x
