...
class AmbiguousSuperF : LeftDefault, RightDefault {
    override fun f(): Int = <!AMBIGUOUS_SUPER!>super<!>.<!DEBUG_INFO_MISSING_UNRESOLVED!>f<!>()
}
...
class AmbiguousSuperTag : LeftTag, RightTag {
    override fun tag(): String = <!AMBIGUOUS_SUPER!>super<!>.<!DEBUG_INFO_MISSING_UNRESOLVED!>tag<!>()
}
...
class AmbiguousSuperVal : LeftVal, RightVal {
    override val n: Int
        get() = <!AMBIGUOUS_SUPER!>super<!>.<!DEBUG_INFO_MISSING_UNRESOLVED!>n<!>
}
