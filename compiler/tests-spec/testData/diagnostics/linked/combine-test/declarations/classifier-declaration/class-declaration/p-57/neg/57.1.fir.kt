 ...
 *                declarations, declarations-with-type-parameters, type-parameter-variance -> paragraph 57 -> sentence 57
...
fun test() = <!CANNOT_INFER_PARAMETER_TYPE!>OutNum<!>(<!ARGUMENT_TYPE_MISMATCH!>"s"<!>)
