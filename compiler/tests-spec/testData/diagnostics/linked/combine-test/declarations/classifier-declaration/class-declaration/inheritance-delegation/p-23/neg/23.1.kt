...
class Box {
    var x: String? by <!DELEGATE_SPECIAL_FUNCTION_NONE_APPLICABLE, DELEGATE_SPECIAL_FUNCTION_NONE_APPLICABLE!>Delegates.<!NEW_INFERENCE_NO_INFORMATION_FOR_PARAMETER!>notNull<!>()<!>
}
