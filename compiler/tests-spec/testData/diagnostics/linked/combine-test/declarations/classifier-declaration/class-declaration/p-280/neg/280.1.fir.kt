 ...
 * NUMBER: 1
 * DESCRIPTION: a protected primary constructor is invisible outside the declaring class hierarchy (INVISIBLE_REFERENCE); covers plain class, generic class, and call from an unrelated top-level class; contrasts with previous-point subclass success and with p-276 private constructor
 */
...
fun case1() {
    <!INVISIBLE_REFERENCE!>TokenBase<!>(1)
}
...
fun case2() {
    <!INVISIBLE_REFERENCE!>CodeBase<!>("x")
}
...
class LabelClient {
    fun make() {
        <!INVISIBLE_REFERENCE!>LabelBase<!>("x")
    }
}
