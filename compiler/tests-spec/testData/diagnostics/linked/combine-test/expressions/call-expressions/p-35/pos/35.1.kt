...
fun case_1() {
    checkSubtype<Pair<Int, String>>(pair<Int, String>(1, "a"))
    checkSubtype<Pair<String, Double>>(pair<String, Double>("x", 2.0))
    checkSubtype<Triple<Int, String, Boolean>>(triple<Int, String, Boolean>(1, "b", true))
}
