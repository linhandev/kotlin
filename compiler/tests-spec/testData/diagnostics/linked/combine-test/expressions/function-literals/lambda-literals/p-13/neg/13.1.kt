...
fun case_1(p: Pair<Int, String>): Int =
    p.let { (<!COMPONENT_FUNCTION_RETURN_TYPE_MISMATCH!>a: String<!>, <!COMPONENT_FUNCTION_RETURN_TYPE_MISMATCH!>b: Int<!>) -> a.<!UNRESOLVED_REFERENCE!>length<!> <!DEBUG_INFO_MISSING_UNRESOLVED!>+<!> b }
