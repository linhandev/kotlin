 ...
 * NUMBER: 1
 * DESCRIPTION: ContinuationInterceptor interceptContinuation return type must match
 */
...
fun case_1() {
    ...
    class BadFullInterceptor18143 : AbstractCoroutineContextElement(ContinuationInterceptor), ContinuationInterceptor {
