 ...
 * NUMBER: 2
 * DESCRIPTION: data class primary constructor parameters must be val or var; plain parameters with Any, function, enum, Nothing, and generic types are rejected
 */
