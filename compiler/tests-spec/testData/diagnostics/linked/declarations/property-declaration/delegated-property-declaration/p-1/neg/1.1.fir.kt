...
val badDelegate: Int <!DELEGATE_SPECIAL_FUNCTION_MISSING!>by<!> MissingGetValue()
...
val wrongType: Int <!DELEGATE_SPECIAL_FUNCTION_RETURN_TYPE_MISMATCH!>by<!> WrongReturnType()
