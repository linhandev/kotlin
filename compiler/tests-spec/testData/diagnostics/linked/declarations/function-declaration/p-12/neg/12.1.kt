...
// TESTCASE NUMBER: 1
fun scalarDefault(vararg xs: Int = <!CONSTANT_EXPECTED_TYPE_MISMATCH!>1<!>): Int = xs.sum()

// TESTCASE NUMBER: 2
fun wrongArrayType(vararg xs: Int = <!TYPE_MISMATCH!>doubleArrayOf(1.0)<!>): Int = xs.sum()
